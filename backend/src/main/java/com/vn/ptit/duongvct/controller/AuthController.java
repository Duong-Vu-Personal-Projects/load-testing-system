...
import com.vn.ptit.duongvct.dto.request.auth.RequestLoginDTO;
import com.vn.ptit.duongvct.dto.request.auth.RequestRegisterDTO;
import com.vn.ptit.duongvct.dto.response.ApiResponse;
import com.vn.ptit.duongvct.dto.response.auth.ResponseLoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResponseRegisterDTO> register(@Valid @RequestBody RequestRegisterDTO dto) throws IllegalArgumentException {
